  ...
  return (
    <div className='mb-10 items-center px-5 flex flex-col gap-2'>
        ...
        text-4xl tracking-wide'>
            Encuentra tu <span className='text-primary'>Especialista</span></h2>
        <h2 className='text-gray-500 text-xl'>Tu doctor o especialista a un click de distancia</h2>

        <div className=" w-full mt-3 max-w-sm items-center space-x-2 hidden">
      ...
      [1,2,3,4,5,6].map((item,index)=>(
        <div key={`numbers${index}`} className=' bg-slate-200 m-2
